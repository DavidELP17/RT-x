package com.redes.comunicacionlinternas.rt_x.MatricesEjemplo;
...
public class MatricesEjemploActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    String codigoguardado_erro = "ERROR";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_matricesejemplo);

        toolbar = (Toolbar) findViewById(R.id.toolbarejmp);
        ...
        if(extras != null)
        {
            ...
            Log.i(TAG, "StringRecibido_Deco1: " + Codigo_Recibido);

            Orden_Recibido = extras.getString("ORDEN");
            Log.i(TAG, "OrdenRecibido_Deco1: " + Orden_Recibido);
    ...
    {
        Intent intent = new Intent(MatricesEjemploActivity.this,HomeActivity.class);
        startActivity(intent);
        MatricesEjemploActivity.this.finish();
    }
    ...
    public void Rellenar(String x)
    {
        ...
        if(!x.equals(codigoguardado_rep) && !x.equals(codigoguardado_rep1))
        {
            Memoria = x;
        }
    ...
    {
        Log.i(TAG, "AgregandoImagen: Fila " + Fila + "  Columna " + Columna + "  Dato " + Bits);
